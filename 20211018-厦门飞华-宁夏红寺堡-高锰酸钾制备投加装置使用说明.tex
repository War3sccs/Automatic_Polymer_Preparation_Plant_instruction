...
\section{系统组成及功能说明}
   ...
   \subsection{系统构成图}
      ...
      \begin{figure}[h]
         ...
         \begin{tikzpicture}
            % \draw (-8,-8) [help lines] grid (8,8);
            % \draw [red] (-8,0) -- (8,0);
            % \draw [red] (0,-8) -- (0,8);
            %定义图像
            \node at (0,0) {\includegraphics[height=15cm]{g0.png}};
         ...
         \begin{figure}[h]
            \centering
               \begin{tikzpicture}
                  ...
                  % \draw [red] (0,-4) -- (0,4);
                  %图片
                  \node [rotate=-90] at (0,0) {\includegraphics[height=6.6cm]{g10.JPG}};
   ...
   \subsection{投加系统的检修维护}
        ...
        \subsubsection{关闭供药阀}
            ...
            \begin{figure}[h]
                ...
                \begin{tikzpicture}
                    %图片
                    \node [rotate=-90] at (0,0) {\includegraphics[height=9cm]{g16.JPG}};
        ...
        \subsubsection{关闭相应工位的加药阀}
            ...
            \begin{figure}[h]
                ...
                \begin{tikzpicture}
                    %图片
                    \node [rotate=-90] at (0,0) {\includegraphics[height=9cm]{g17.JPG}};
