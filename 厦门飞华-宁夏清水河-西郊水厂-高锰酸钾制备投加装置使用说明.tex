...
\section{日常操作}
   ...
   \subsection{设备操作}\label{sec:s1}
      ...
      \begin{figure}[h]
         \centering
            \begin{tikzpicture}
               ...
               %说明
               \node at (-5,2.7) (1) [text_box, color=red] {低源水水量};
      ...
      \end{figure}
            ...
            \par高锰酸钾计量泵控制：
            \begin{itemize}
                \item 如果计量泵隔膜破裂，则隔膜状态会亮红灯，正常时为绿灯。
                \item 冲程长度按现场计量泵的实际冲程长度填写，出厂设置为60\%。
                \item 当计量泵控制方式设为自动时，变频器频率设定框会变为灰色，
                    且不可修改，控制方式设为手动时，
                    可手动设置计量泵变频器运行频率。
                \item 变频器故障时，
                    故障状态会亮红灯，
